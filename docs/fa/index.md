...
آزمایشگاه تحقیقاتی مهندسی نرم‌افزار هوشمند [دانشگاه صنعتی امیرکبیر (پلی‌تکنیک تهران)](https://aut.ac.ir/){target="_blank"} در زمینه توسعه فناوری‌های مرتبط با سنجش و بهبود کیفیت فرایندها، کیفیت مصنوعات  سیستم‌های نرم‌افزاری، آزمون نرم‌افزار، مهندسی معکوس و تکامل نرم‌افزار فعالیت می‌کند. هدف خودکارسازی وظایف مرتبط با مهندسی نرم‌افزار در سطوح مختلف از طراحی و توسعه تا محصول نهایی با بهره‌گیری از فنون هوش مصنوعی، کامپایلرها و زبانهای خاص منظوره است. نتیجه، کاهش هزینه‌ها و افزایش بازدهی تیم‌های نرم‌افزاری است.
فعالیت‌های آزمایشگاه در سه بخش پژوهش، صنعت و آموزش سازمان دهی و دنبال می‌گردد.  
